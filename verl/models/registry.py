...
from transformers import LlamaConfig, MistralConfig, GemmaConfig, Qwen2Config, Gemma2Config

_REOVEPAD_MODELS = {'llama': LlamaConfig, 'mistral': MistralConfig, 'gemma': GemmaConfig, 'qwen2': Qwen2Config, "gemma2": Gemma2Config}
